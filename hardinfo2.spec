...
Version  : 2.2.10
Release  : 7
URL      : https://github.com/hardinfo2/hardinfo2/archive/release-2.2.10/hardinfo2-2.2.10.tar.gz
Source0  : https://github.com/hardinfo2/hardinfo2/archive/release-2.2.10/hardinfo2-2.2.10.tar.gz
...
%prep
%setup -q -n hardinfo2-release-2.2.10
cd %{_builddir}/hardinfo2-release-2.2.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743431268
mkdir -p clr-build
pushd clr-build
