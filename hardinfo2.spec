...
#
Name     : hardinfo2
Version  : elease.2.1.14
Release  : 1
URL      : https://github.com/hardinfo2/hardinfo2/archive/refs/tags/release-2.1.14.tar.gz
Source0  : https://github.com/hardinfo2/hardinfo2/archive/refs/tags/release-2.1.14.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726249274
mkdir -p clr-build
pushd clr-build
