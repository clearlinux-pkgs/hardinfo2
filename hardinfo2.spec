...
Version  : 2.2.7
Release  : 6
URL      : https://github.com/hardinfo2/hardinfo2/archive/release-2.2.7/hardinfo2-2.2.7.tar.gz
Source0  : https://github.com/hardinfo2/hardinfo2/archive/release-2.2.7/hardinfo2-2.2.7.tar.gz
...
%prep
%setup -q -n hardinfo2-release-2.2.7
cd %{_builddir}/hardinfo2-release-2.2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738597578
mkdir -p clr-build
pushd clr-build
...
/usr/share/hardinfo2/pixmaps/distros/alt.svg
