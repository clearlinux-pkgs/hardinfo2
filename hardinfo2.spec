...
Version  : 2.2.4
Release  : 5
URL      : https://github.com/hardinfo2/hardinfo2/archive/release-2.2.4/hardinfo2-2.2.4.tar.gz
Source0  : https://github.com/hardinfo2/hardinfo2/archive/release-2.2.4/hardinfo2-2.2.4.tar.gz
...
%prep
%setup -q -n hardinfo2-release-2.2.4
cd %{_builddir}/hardinfo2-release-2.2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730819844
mkdir -p clr-build
pushd clr-build
